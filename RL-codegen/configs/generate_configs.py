...
parser.add_argument("--score_name", default="", type=str, help='Name to save reward score as')
...
parser.add_argument("--reward_scores", default=False, action='store_true', help='if model is a reward model, enable this to output reward scores')
...
parser.add_argument('--baseline', default=False, action='store_true', help='Wether to do greedy sampling for the baseline or not')
parser.add_argument('--logits', default=False, action='store_true', help='Wether to return the logits when sampling (for measuring KL divergence)')
